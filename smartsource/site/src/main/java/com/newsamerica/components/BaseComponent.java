package com.newsamerica.components;

import java.util.ArrayList;
import java.util.List;

import com.newsamerica.componentsinfo.GeneralListInfo;
import com.newsamerica.componentsinfo.PageableListInfo;
    ...
    protected void createAndExecuteSearch(final HstRequest request, final GeneralListInfo info, final HippoBean scope, final String query) throws HstComponentException {
        ...
        try {
           ...
           // System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
            ...
            String ids = getPublicRequestParameter(request, "ids");
            if(ids == null) {
                // test namespaced query parameter
            	ids = request.getParameter("ids");
            }
          //  System.out.println(">>>>>>>>>>77777>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"+ids);
